...
class CoverFragment : BaseFragment<BasePresenter<BaseContract.BaseView>>() {
    ...
    private lateinit var coverView: CircleImageView
    private lateinit var cover2View: CircleImageView
    private lateinit var tvQuality: TextView
    private lateinit var tvSource: TextView
    private lateinit var tvSoundEffect: TextView
    ...
    override fun initViews() {
        ...
        tvSoundEffect = rootView.findViewById(R.id.tv_sound_effect)

        //音效点击
        tvSoundEffect.setOnClickListener {
        ...
        tvQuality.setOnClickListener {
            QualitySelectDialog.newInstance(PlayManager.getPlayingMusic()).apply {
                changeSuccessListener = {
                    this@CoverFragment.tvQuality.text = it
                }
                isDownload = false
