...
class MyMusicFragment : BaseFragment<MyMusicPresenter>(), MyMusicContract.View {
    ...
    private lateinit var videoView : LocalItemView
    private lateinit var favoriteView : LocalItemView
    private lateinit var historyView : LocalItemView
    private lateinit var downloadView : LocalItemView
    private lateinit var localView : LocalItemView
    private lateinit var playlistRcv : RecyclerView
    private lateinit var playlistTab : TabLayout
    private lateinit var playlistAddIv : ImageView
    private lateinit var playlistManagerIv : ImageView
    ...
    public override fun initViews() {
        ...
        favoriteView = rootView.findViewById(R.id.favoriteView)
        ...
        playlistRcv = rootView.findViewById(R.id.playlistRcv)
        playlistTab = rootView.findViewById(R.id.playlistTab)
        playlistAddIv = rootView.findViewById(R.id.playlistAddIv)
        playlistManagerIv = rootView.findViewById(R.id.playlistManagerIv)
        //初始化下载 Item
