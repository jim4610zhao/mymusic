...
class NewDiscoverFragment : BaseLazyFragment<DiscoverPresenter>(), DiscoverContract.View, View.OnClickListener {
    ...
    private lateinit var cateTagTv: TextView
    private lateinit var catTag3Tv: TextView
    private lateinit var catTag1Tv: TextView
    private lateinit var catTag2Tv: TextView
    private lateinit var singerListTv: TextView
    private lateinit var hotSingerTv: TextView
    private lateinit var radioTv: TextView
    private lateinit var personalFmTv: TextView
    private lateinit var seeAllRadioTv: TextView
    private lateinit var seeAllArtistTv: TextView
    private lateinit var recommendSongsTv: TextView
    private lateinit var containerView: NestedScrollView
    private lateinit var mzBannerView: MZBannerView<BannerBean>
    private lateinit var wangChartsRv: RecyclerView
    private lateinit var chartsArtistRcv: RecyclerView
    private lateinit var radioRsv: RecyclerView
    private lateinit var recommendPlaylistRsv: RecyclerView
    private lateinit var recommendRsv: RecyclerView
    private lateinit var recommendPlaylistView: LinearLayout
    private lateinit var recommendView: LinearLayout
    private lateinit var playlistView: LinearLayout
    private lateinit var artistView: LinearLayout
    private lateinit var radioView: LinearLayout
    ...
    override fun initViews() {
        radioTv = rootView.findViewById(R.id.radioTv)
        personalFmTv = rootView.findViewById(R.id.personalFmTv)
        seeAllRadioTv = rootView.findViewById(R.id.seeAllRadioTv)
        seeAllArtistTv = rootView.findViewById(R.id.seeAllArtistTv)
        recommendSongsTv = rootView.findViewById(R.id.recommendSongsTv)
        catTag1Tv = rootView.findViewById(R.id.catTag1Tv)
        cateTagTv = rootView.findViewById(R.id.cateTagTv)
        catTag2Tv = rootView.findViewById(R.id.catTag2Tv)
        catTag3Tv = rootView.findViewById(R.id.catTag3Tv)
        singerListTv = rootView.findViewById(R.id.singerListTv)
        hotSingerTv = rootView.findViewById(R.id.hotSingerTv)
        containerView = rootView.findViewById(R.id.containerView)
        mzBannerView = rootView.findViewById(R.id.mzBannerView)
        wangChartsRv = rootView.findViewById(R.id.wangChartsRv)
        chartsArtistRcv = rootView.findViewById(R.id.chartsArtistRcv)
        radioRsv = rootView.findViewById(R.id.radioRsv)
        recommendPlaylistRsv = rootView.findViewById(R.id.recommendPlaylistRsv)
        recommendRsv = rootView.findViewById(R.id.recommendRsv)
        recommendPlaylistView = rootView.findViewById(R.id.recommendPlaylistView)
        recommendView = rootView.findViewById(R.id.recommendView)
        playlistView = rootView.findViewById(R.id.playlistView)
        artistView = rootView.findViewById(R.id.artistView)
        radioView = rootView.findViewById(R.id.radioView)
    }
