...
class SleepTimerActivity : BaseActivity<BasePresenter<BaseContract.BaseView>>() {
    private val closeAppTipsTv by lazy { findViewById<TextView>(R.id.closeAppTipsTv) }
    ...
    private val playControlSwitch by lazy { findViewById<SwitchCompat>(R.id.playControlSwitch) }
