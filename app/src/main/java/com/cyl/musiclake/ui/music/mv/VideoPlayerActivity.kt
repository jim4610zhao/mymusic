...
import com.cyl.musiclake.databinding.ActivityVideoBinding
...
class VideoPlayerActivity : BaseVideoPlayerActivity() {
    ...
    override fun initView() {
        viewBinding.videoView.controllerHideOnTouch = true//?.setVisibilityListener(ControlsVisibilityListener())
    }
    ...
    override fun initData() {
        ...
        ExoPlayerManager.bindView(viewBinding.videoView)
        //加载本地视频
