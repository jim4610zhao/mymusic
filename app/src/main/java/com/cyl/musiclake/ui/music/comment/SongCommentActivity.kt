...
import com.cyl.musiclake.databinding.ActivitySongCommentBinding
import com.cyl.musiclake.databinding.FragArtistDetailBinding
...
class SongCommentActivity : BaseActivity<BasePresenter<BaseContract.BaseView>>() {
    ...
    private val viewBinding by lazy { ActivitySongCommentBinding.inflate(layoutInflater) }
...
//        hotCommentRsv.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
        viewBinding.newCommentRsv.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(this, androidx.recyclerview.widget.LinearLayoutManager.VERTICAL, false)
    }
    ...
    private fun updateSongComment(comments: MutableList<SongComment>?) {
        ...
        if (commentAdapter == null) {
            ...
            viewBinding.newCommentRsv.adapter = commentAdapter
        } else {
