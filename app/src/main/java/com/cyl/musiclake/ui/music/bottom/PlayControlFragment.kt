...
class PlayControlFragment : BaseFragment<PlayPresenter>(), SeekBar.OnSeekBarChangeListener,
    PlayContract.View {
    ...
    private lateinit var bottomPlayRcv: RecyclerView
    private lateinit var playQueueIv: ImageView
    ...
    public override fun initViews() {
        bottomPlayRcv = rootView.findViewById(R.id.bottomPlayRcv)
        playQueueIv = rootView.findViewById(R.id.playQueueIv)
        playPauseView = rootView.findViewById(R.id.playPauseView)
    ...
    override fun listener() {
        bottomPlayRcv.setOnClickListener { v ->
            NavigationHelper.navigateToPlaying(
